...
if("TRUE" STREQUAL "TRUE")
  set(test_diagnostic_aggregator_SOURCE_PREFIX /home/odroid/ros_catkin_ws/src/diagnostics/test_diagnostic_aggregator)
  set(test_diagnostic_aggregator_DEVEL_PREFIX /home/odroid/ros_catkin_ws/devel)
  ...
  set(test_diagnostic_aggregator_INSTALL_PREFIX /home/odroid/ros_catkin_ws/install)
...
if(NOT "/home/odroid/ros_catkin_ws/src/diagnostics/test_diagnostic_aggregator/include " STREQUAL " ")
  set(test_diagnostic_aggregator_INCLUDE_DIRS "")
  set(_include_dirs "/home/odroid/ros_catkin_ws/src/diagnostics/test_diagnostic_aggregator/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'test_diagnostic_aggregator' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Brice Rebsamen <brice.rebsamen@gmail.com>, Austin Hendrix <namniart@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'test_diagnostic_aggregator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/odroid/ros_catkin_ws/src/diagnostics/test_diagnostic_aggregator/${idir}'.  Ask the maintainer 'Brice Rebsamen <brice.rebsamen@gmail.com>, Austin Hendrix <namniart@gmail.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${test_diagnostic_aggregator_dep}_FOUND)
      find_package(${test_diagnostic_aggregator_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${test_diagnostic_aggregator_dep} REQUIRED ${depend_list})
  endif()
